...
#define EVENT_WAKE          0xF6   //new phisical incoming connecting
#define EVENT_BUSY          0x1F6  //unwanted incoming call
...
#define CR_NAME  0x8D //name of incoming contact from ST
...
#define UI_WAKE    0xD8 //new phisical incoming connecting
