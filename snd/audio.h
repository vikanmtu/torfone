...
//#define BEEP_ROGER //short beep signal on start of remote speech pause 

//simple echo supressor settings for Mike supressing
#define SP_ECHOSMOOTH 3 //for 8: average frames measuring speaker level
#define SP_MAXLEVEL 2048  //up trashold of speaker level for maximal de-echo
#define SP_MINLEVEL 256 //down trashold of speaker level for start de-echo
#define SP_LEVEL 250  //maximal decreasing factor

//simple echo supressor settings for Speaker supressing
#define MK_ECHOSMOOTH 3 //for 8: average frames measuring speaker level
#define MK_MAXLEVEL 2048  //up trashold of speaker level for maximal de-echo
#define MK_MINLEVEL 256 //down trashold of speaker level for start de-echo
#define MK_LEVEL 250 //maximal decreasing factor
...
#define MINPLAYDELAY 640 //mininam number of samples in playing buffer  (2 new frames will be requested)
#define NOMPLAYDELAY 960  //nominal number of samples in playing buffer  (1 new frames will be requested)
#define MAXPLAYDELAY 1280 //maximal number of samples in playing buffer  (0 new frames will be requested)
...
unsigned int mklevel; //energy of recorded sound
...
unsigned char volume; //speacker volume level supression level
